    ...
    <div className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-trade-dark mb-4">Contact Us</h2>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <form className="space-y-4">
                  ...
                  <Button className="bg-trade-primary hover:bg-trade-dark">Send Message</Button>
                </form>
              </CardContent>
            </Card>
          </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <Mail className="h-5 w-5 text-trade-primary mr-3 mt-0.5" />
                    <div>
                      <h4 className="font-medium">Email</h4>
                      <p className="text-gray-600">alshbhh@outlook.com</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <Phone className="h-5 w-5 text-trade-primary mr-3 mt-0.5" />
                    <div>
                      <h4 className="font-medium">Phone</h4>
                      <p className="text-gray-600">+20 1204486263</p>
                      <p className="text-gray-600 text-sm mt-1">Available via WhatsApp</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <MapPin className="h-5 w-5 text-trade-primary mr-3 mt-0.5" />
                    <div>
